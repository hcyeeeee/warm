...
<template>
    <div class="layout" id="people">
        <div class="layout">
            <div class="title_row">
                <img src="../assets/title4.png" alt="" class="title_icon" />
        ...
        <button v-on:click="myFunction" id="myBtn4">閱讀<br />更多</button>
    </div>
</template>
<script>
export default {
    ...
    mounted() {
        ...
        axios
            .get('https://ftvnews-api2.azurewebsites.net/API/FtvGetNewsWeb.aspx?Cate=勵志人物&Page=1&sp=20')
            .then((response) => {
    ...
    methods: {
        ...
        myFunction: function () {
            ...
            if (dots.style.display === 'none') {
                ...
                btnText.innerHTML =
                    ' <a href="https://www.ftvnews.com.tw/tag/勵志人物" target="_blank" style="color: black">更多<br>新聞</a>'
