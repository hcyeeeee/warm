...
<template>
    <div class="layout" id="pet">
        <div class="layout">
            <div class="title_row">
                <img src="../assets/title1.png" alt="" class="title_icon" />
        ...
        <button v-on:click="myFunction" id="myBtn">閱讀<br />更多</button>
    </div>
</template>
<script>
export default {
    ...
    mounted() {
        ...
        axios
            .get('https://ftvnews-api2.azurewebsites.net/API/FtvGetNewsWeb.aspx?Cate=療癒毛孩&Page=1&sp=20')
            .then((response) => {
    ...
    methods: {
        ...
        myFunction: function () {
            ...
            if (dots.style.display === 'none') {
                ...
                btnText.innerHTML =
                    ' <a href="https://www.ftvnews.com.tw/tag/療癒毛孩" target="_blank" style="color: black ; text-decoration:none;">更多<br>新聞</a>'
