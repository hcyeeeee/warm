...
<template>
    <div class="layout" id="good">
        <div class="layout">
            <div class="title_row">
                <img src="../assets/title6.png" alt="" class="title_icon" />
        ...
        <button v-on:click="myFunction" id="myBtn6">閱讀<br />更多</button>
    </div>
</template>
<script>
export default {
    ...
    mounted() {
        ...
        axios
            .get('https://ftvnews-api2.azurewebsites.net/API/FtvGetNewsWeb.aspx?Cate=公益送暖&Page=1&sp=20')
            .then((response) => {
    ...
    methods: {
        ...
        myFunction: function () {
            ...
            if (dots.style.display === 'none') {
                ...
                btnText.innerHTML =
                    ' <a href="https://www.ftvnews.com.tw/tag/公益送暖" target="_blank" style="color: black">更多<br>新聞</a>'
